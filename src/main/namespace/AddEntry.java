...
public class AddEntry extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        activityItems = new String[] {"Rygg","Bröst","Armar","Ben","Överkropp"};
        spinner = (Spinner) findViewById(R.id.firstspinner);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                    android.R.layout.simple_spinner_item, activityItems);
	...
	public void onClick(View v) {
		...
		try {
			...
			String semiactivity = activityItems[spinner.getSelectedItemPosition()];	
			
			 String activity = "Gym " + semiactivity;
			 String duration = timeItems[spinner2.getSelectedItemPosition()];
		...
		case (R.id.delete):
			...
			DataHelper del = new DataHelper(this);
