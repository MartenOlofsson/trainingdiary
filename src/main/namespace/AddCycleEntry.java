...
public class AddCycleEntry extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addcycleentry);
        
       
        
        
        timeItems = new String[] {"15 min","30 min","45 min","60 min","90 min","120 min"};
        spinner2 = (Spinner) findViewById(R.id.cyclespinner);
